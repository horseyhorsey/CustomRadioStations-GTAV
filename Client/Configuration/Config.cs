...
namespace CustomRadioStations
{
    ...
    {        
        ...
        public static Control KB_Toggle;
        ...
        public static string[] WheelCats;
        ...
        public static void SaveINI()
        {
            ...
            config.SetValue<float>(INI_SECTION_GENERAL, "DEFAULT VOLUME (0 to 1.0)", SoundFile.SoundVolume, comment);
            ...
            config.SetValue<Control>(INI_SECTION_KEYBOARD_CONTROLS, "Toggle: Q +", KB_Toggle, comment);
        ...
        public static void LoadINI()
        {
            ...
            SoundFile.SoundVolume = config.GetValue<float>(INI_SECTION_GENERAL, "DEFAULT VOLUME (0 to 1.0)", 0.3f);
            ...
            KB_Toggle = config.GetValue<Control>(INI_SECTION_KEYBOARD_CONTROLS, "Toggle: Q +", Control.Pickup);
            ...
            //var wCats = config.GetValue<string>(INI_SECTION_WHEELS, "CATS", string.Empty);
            //WheelCats = wCats.Split(',');
        ...
        /// <returns>iconX, iconY, wheelradius</returns>
        public static Tuple<int, int, float> LoadWheelINI(string directory)
        {
            ForceDecimal();
            ...
            return new Tuple<int,int,float>(iconX, iconY, wheelRadius);
        }
        ...
        public static void UpdateWheelsVisuals()
        {
            foreach (var pair in StationWheelPair.List)
            {
                ...
                pair.Wheel.TextureSize = new Size(wheelIni.Item1, wheelIni.Item2);
                pair.Wheel.Radius = wheelIni.Item3;
        ...
        {
            culture = new CultureInfo(System.Threading.Thread.CurrentThread.CurrentCulture.Name);
        ...
        public static async Task LoadTickAsync()
        {
            if (loadCounter % loadInterval == 0)
            {
                await BaseScript.Delay(LoadMS);
            }
