...
namespace CustomRadioStations
{
    ...
    {
        public static string InputString(Control control, int controlInt = -1)
        {
        ...
        public static string InputString(string keyboardKey, Control control, int controlInt = -1)
        {
            if (!UsingGamepad())
            {
                return keyboardKey;
        ...
        //public static string InputString(System.Windows.Forms.Keys key, Control control, int controlInt = -1)
        //{
        //    if (!UsingGamepad())
        //    {
        //        return key.ToString();
        ...
        public static bool UsingGamepad() => Function.Call<bool>((Hash)0xA571D46727E2B718, 2) ? false : true;
